...
function Dance(object){
	if(object.action =="turnon"){
		...
		for(var f=object.xrange[0];f<=object.xrange[1];f++){
			for(var g=object.yrange[0];g<=object.yrange[1];g++){
				ALLOFTHELIGHTS[f][g] = Number(!(ALLOFTHELIGHTS[f][g]));
			}
		}
	}
}
...
console.log("Your Christmas lights gave all of your neighbors epilepsy.");
console.log("This is how many lights are on.")

var counter=0;
for(var a=0;a<1000;a++){
	for(b=0;b<1000;b++){
		counter+=ALLOFTHELIGHTS[a][b];
	};
};
console.log(counter);